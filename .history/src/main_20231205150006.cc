...

    {
      ...
      if (m) {
        ...
        if (sim.run) {
          ...
          if(initialpos == true)
          {
            d->qpos[0] = 30.0 * DEG2RAD; // to avoid self collision
            d->qpos[1] = 30.0 * DEG2RAD; // to avoid self collision
            d->qpos[2] = 30.0 * DEG2RAD; // to avoid self collision
            d->qpos[3] = 30.0 * DEG2RAD; // to avoid self collision
            d->qpos[4] = 30.0 * DEG2RAD; // to avoid self collision
            d->qpos[5] = 30.0 * DEG2RAD; // to avoid self collision    
            d->qpos[6] = 30.0 * DEG2RAD; // to avoid self collision
            initialpos = false;
          }

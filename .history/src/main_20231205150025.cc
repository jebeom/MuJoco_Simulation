      ...
      if (m) {
        ...
        if (sim.run) {
          ...
          if(initialpos == true)
          {
            ...
            d->qpos[1] = ; // to avoid self collision
            d->qpos[2] = ; // to avoid self collision
            d->qpos[3] = ; // to avoid self collision
            d->qpos[4] = ; // to avoid self collision
            d->qpos[5] = ; // to avoid self collision    
            d->qpos[6] = ; // to avoid self collision
            initialpos = false;
          }

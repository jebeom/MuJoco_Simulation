...
void CController::ModelUpdate()
{
	...
	cout << Model._R_hand.transpose() << endl;
...
{	
	if (_bool_plan(_cnt_plan) == 1)
	{
		if(_cnt_plan == 0)
		{
			...
			Vector3d target_pos;
			Vector3d target_ori;
			target_pos(0) = 0.118495;
			target_pos(1) = -0.348324;
			target_pos(2) = 0.837614;
			target_ori(0) = 2.91158;
			target_ori(1) = 0.475876;
			target_ori(2) = -0.985739;
